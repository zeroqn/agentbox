...
#[repr(C)]
#[derive(Debug, Copy, Clone, Default, IntoBytes, Immutable, FromBytes, KnownLayout)]
...
#[repr(C)]
#[derive(Debug, Copy, Clone, Default, IntoBytes, Immutable, FromBytes)]
...
#[repr(C)]
#[derive(Copy, Clone, Default, IntoBytes, Immutable, FromBytes, KnownLayout)]
