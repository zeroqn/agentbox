...
const FISH_CONFIG_SOURCE_ENV: &str = "CANG_FISH_CONFIG_SOURCE";
const STARSHIP_CONFIG_SOURCE_ENV: &str = "CANG_STARSHIP_CONFIG_SOURCE";
...
pub(in crate::guest_init) fn materialize_config_files(
    ...
    copy_config_file_if_missing(
        &sources.fish_config,
        &fish_conf_dir.join("cang-starship.fish"),
        identity,
        set_ownership,
    )
