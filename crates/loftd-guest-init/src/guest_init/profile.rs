...
pub(in crate::guest_init) const GUEST_PROFILE_ENV: &str = "LOFTD_GUEST_PROFILE";
pub(in crate::guest_init) const GUEST_DEBUG_ENV: &str = "LOFTD_GUEST_DEBUG";
...
impl GuestProfiler {
    ...
    fn write_report_with_total(&self, writer: &mut impl Write, total: Duration) -> io::Result<()> {
        ...
        writeln!(writer, "loftd-guest-init profile: {}", self.section)?;
