...
pub(crate) fn read_state_location_override(
...
mod tests {
    ...
    #[test]
    fn parser_ignores_agentbox_config_section_names() {
        let location = crate::config::state::parse_state_location_override(
            "[agentbox]\nlocation = \"/tmp/wrong\"\n",
        )
        .expect("unknown section should be ignored");
