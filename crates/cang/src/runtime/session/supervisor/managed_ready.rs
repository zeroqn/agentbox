...
use cang_attach_protocol::{Frame, PROTOCOL_VERSION, read_frame, write_frame};
use std::ffi::CString;
use std::fs;
...
pub(crate) const MANAGED_ATTACH_READY_TIMEOUT_ENV: &str = "CANG_MANAGED_ATTACH_READY_TIMEOUT_SECS";
pub(crate) const MANAGED_HELPER_READY_TIMEOUT_ENV: &str = "CANG_MANAGED_HELPER_READY_TIMEOUT_SECS";
