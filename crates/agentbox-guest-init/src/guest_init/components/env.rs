...
pub(in crate::guest_init) const NIX_STATUS_PATH: &str = "/run/agentbox/nix-prep.status";
pub(in crate::guest_init) const NIX_LOG_PATH: &str = "/run/agentbox/nix-prep.log";
...
pub(in crate::guest_init) const DOCKER_PREP_STATUS_PATH: &str = "/run/agentbox/docker-prep.status";
pub(in crate::guest_init) const DOCKER_PREP_LOG_PATH: &str = "/run/agentbox/docker-prep.log";
pub(in crate::guest_init) const DOCKER_WAIT_TIMEOUT_SECS: u64 = 120;
pub(in crate::guest_init) const DOCKER_DAEMON_TIMEOUT_SECS: u64 = 60;
