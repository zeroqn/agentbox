...
pkgs.stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  node_modules = pkgs.stdenvNoCC.mkDerivation {
    ...
    # Required, otherwise the fixed-output derivation can reject store-path references.
    dontFixup = true;

    outputHash = pins.opencode.nodeModulesHash;
  ...
  passthru = {
    ...
    sourceUrl = "https://github.com/anomalyco/opencode/archive/refs/tags/v${finalAttrs.version}.tar.gz";
  };
