{
  ...
  dirge = {
    ...
    repo = "dirge";
    rev = "v0.16.0";
    srcHash = "sha256-RpRNUF298VIj/kHuyAlk+7FYuoPCfiFxttXPUICipNY=";
  };
  ...
  agentboxPrebuiltRelease = {
    ...
    tag = "sha-4c037921cfaf";
    systems = {
      x86_64-linux = {
        asset = "agentbox-x86_64-unknown-linux-musl";
        hash = "sha256-CXf6aJ8aF5w9R3VkenF3Ztw/FlpaLVpJDhE8XayybpE=";
      };
    };
  };
  ...
  loftdPrebuiltRelease = {
    ...
    # release payloads.
    tag = "sha-c8ea954db115";
    systems = {
      x86_64-linux = {
        asset = "loftd-x86_64-unknown-linux-gnu";
        hash = "sha256-RdN+m2wkeBiQ4lL+CxwQWiEjUXaYjv2uWcrGqkGg2r0=";
      };
    };
  };
