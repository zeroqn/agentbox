...
in
{
  ...
  dirge = {
    ...
    repo = "dirge";
    rev = "v0.19.1";
    srcHash = "sha256-di6VCB/H6RmO225SMwMZeVDGc8YwqhNvpuEGim8X58I=";
  };
  ...
  agentboxPrebuiltRelease = {
    ...
    tag = "sha-076069f98149";
    systems = {
      x86_64-linux = {
        asset = "agentbox-x86_64-unknown-linux-musl";
        hash = "sha256-7MeRwVwx+3IuMe4BUXDfhmY53mfrUpK5CbF4uftpBVQ=";
      };
    };
  };
  ...
  loftdPrebuiltRelease = {
    ...
    systems = {
      x86_64-linux = {
        ...
        hash = "sha256-+u1rR5fkspQXs38kRbhZ1Zgp6u0uMJlmAQ1kmnPks7w=";
      };
    };
  };
